        ...
        if top_learned:
            ...
            st.dataframe(
                ...
                column_config={
                    ...
                    "item_id": st.column_config.TextColumn("Item ID", width=120),
                    "profit_mean": st.column_config.NumberColumn("Avg Profit", format="₽%.0f"),
                    "roi_mean": st.column_config.NumberColumn("Avg ROI", format="%.1f%%"),
                    "consistency_score": st.column_config.ProgressColumn("Consistency", min_value=0, max_value=100),
                    "profitable_rate": st.column_config.ProgressColumn("Profit Rate", min_value=0, max_value=100, format="%.0f%%"),
                    "liquidity_mean": st.column_config.ProgressColumn("Liquidity", min_value=0, max_value=100),
                    "data_points": st.column_config.NumberColumn("Samples"),
